...
/**
 * @ClassName: ReceiveXmlProcess
 * @Description: 解析接收到的微信xml，返回消息对象
 * @author renzx
 * @date Apr 12, 2017
 */
public class ReceiveXmlProcess {
    ...
    public ReceiveXmlEntity getMsgEntity(String strXml) {
        ...
        try {
            ...
            // 利用反射机制，调用set方法
            // 获取该实体的元类型
            Class<?> c = Class.forName("ren.ashin.wechat.intfc.demo.entity.ReceiveXmlEntity");
